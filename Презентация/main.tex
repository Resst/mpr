...
% Слайд 6: Интервальные значения и центры
\begin{frame}{Шаг 6: Интервальные значения меры компромисса}
...
% Слайд 7: Проверка условий C1 и C2
\begin{frame}{Шаг 7: Проверка компромиссного решения по условиям C1 и C2}
