...
\makeatletter
\newcommand\mailtoab[3]{\href{mailto:#1?subject=#2}{#3}}
\makeatother
	
	
	%${email}{Subject}{email start body}{text in pdf}
\makeatletter
\newcommand\mailto[4]{\href{mailto:#1?subject=#2\&body=#3}{#4}}
\makeatother

%% MLABSED 2017 author
\makeatletter
\newcommand\mailtoMLABSEDauthor[3]{\href{mailto:#1?subject=MLABSED 2017\&body=#2}{#3}}
\makeatother

%% Convenience shortcuts with predefined recipients
\makeatletter
\newcommand\mailtopa[1]{\href{mailto:parhomenko.v@gmail.com?subject=#1\&body=Dear Vladimir,}{Vladimir.Parkhomenko@spbstu.ru}}
\newcommand\mailtobu[1]{\href{mailto:abuzmakov@gmail.com?subject=#1\&body=Dear Alexey,}{abuzmakov@gmail.com}}
\newcommand\mailtona[1]{\href{mailto:ksennaidd@gmail.com?subject=#1\&body=Dear Xenia,}{ksennaidd@gmail.com}}
\newcommand\mailtosh[1]{\href{mailto:shvetsov@inbox.ru?subject=#1\&body=Dear Konstantin,}{Konstantin.Shvetsov@spbstu.ru}}
\makeatother
